      ...
      <div className="w-full max-w-md">
        <Card className="backdrop-blur-sm bg-white/80 shadow-xl border-0 ring-1 ring-gray-200/50">
          <CardHeader className="text-center pb-4">
            <CardTitle className={`text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent transition-all duration-500 ${isAnimating ? 'scale-110' : 'scale-100'}`}>
              {getGreetingMessage()}
            </CardTitle>
